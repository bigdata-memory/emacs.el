...
It depends on a recent version of Org that causes mixed installation of =Org-mode= and can lead to troubles. the =list-load-path-shadows= can be used to check this issue.
...
#+begin_src emacs-lisp
  (use-package treemacs
    ...
    :bind
    (:map global-map
          ("C-c C-M-t s" . treemacs-select-window)
          ("C-c C-M-t t" . treemacs)
          ("C-c C-M-t f" . treemacs-find-tag))
...
#+begin_src emacs-lisp
  ...
  (use-package lsp-mode
    ...
    :init
    (setq lsp-keymap-prefix "C-c C-M-SPC")  ;; Or 'C-l', 's-l'
    :config
